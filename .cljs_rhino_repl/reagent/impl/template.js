...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30926__auto__,writer__30927__auto__,opt__30928__auto__){
return cljs.core._write.call(null,writer__30927__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__59375 = o;
(G__59375[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__59377__i < G__59377__a.length) {G__59377__a[G__59377__i] = arguments[G__59377__i + 0]; ++G__59377__i;}
  args = new cljs.core.IndexedSeq(G__59377__a,0);
} 
...
if(cljs.core.truth_((function (){var and__30303__auto__ = !((jsprops == null));
if(and__30303__auto__){
var and__30303__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__59383 = jsprops;
(G__59383["defaultValue"] = value);

(G__59383["onChange"] = ((function (G__59383,v,value,on_change){
return (function (p1__59381_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__59381_SHARP_);
});})(G__59383,v,value,on_change))
);
...
var vec__59390 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__59390,(0),null);
var id = cljs.core.nth.call(null,vec__59390,(1),null);
var class$ = cljs.core.nth.call(null,vec__59390,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___59395 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___59395 == null)){
} else {
var key_59396 = temp__4661__auto___59395;
(jsprops["key"] = key_59396);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__59398 = (new reagent.impl.template.NativeWrapper());
(G__59398["name"] = c);
...
var len__31428__auto___59404 = arguments.length;
var i__31429__auto___59405 = (0);
while(true){
if((i__31429__auto___59405 < len__31428__auto___59404)){
args__31435__auto__.push((arguments[i__31429__auto___59405]));

var G__59406 = (i__31429__auto___59405 + (1));
i__31429__auto___59405 = G__59406;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31436__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq59402){
var G__59403 = cljs.core.first.call(null,seq59402);
var seq59402__$1 = cljs.core.next.call(null,seq59402);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__59403,seq59402__$1);
});
...
break;
default:
var G__59410 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__59410;
continue;
...
var n__31238__auto___59413 = a.length;
var i_59414 = (0);
while(true){
if((i_59414 < n__31238__auto___59413)){
(a[i_59414] = reagent.impl.template.as_element.call(null,(a[i_59414])));

var G__59415 = (i_59414 + (1));
i_59414 = G__59415;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31238__auto___59416 = a.length;
var i_59417 = (0);
while(true){
if((i_59417 < n__31238__auto___59416)){
var val_59418 = (a[i_59417]);
if((cljs.core.vector_QMARK_.call(null,val_59418)) && ((reagent.impl.template.key_from_vec.call(null,val_59418) == null))){
(o["no-key"] = true);
} else {
}

(a[i_59417] = reagent.impl.template.as_element.call(null,val_59418));

var G__59419 = (i_59417 + (1));
i_59417 = G__59419;
continue;
} else {
}
...
var ctx = ({});
var vec__59423 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__59423,(0),null);
var derefed = cljs.core.nth.call(null,vec__59423,(1),null);
...
var G__59427 = (cljs.core.count.call(null,argv) - first_child);
switch (G__59427) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__59427){
